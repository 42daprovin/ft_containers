...
#ifdef FT
using namespace ft;
#define NAMESPACE_DEFINED #define FLAG "FT"
#endif
...
int main() {
	...
	std::cout << ".........Casting Iteartors.........." << std::endl << std::endl;
    {
        vector<int> myvector;
        for (int i=1; i<=5; i++) myvector.push_back(i);
	...
	std::cout << ".......Bidirectional iterators......" << std::endl << std::endl;
	{
		std::list<int> lst;
	...
	std::cout << "...............Pup_back.................." << std::endl << std::endl;
    {
        vector<int> myvector;
	...
	/* std::cout << "File compiled with: " << FLAG << std::endl; */
    return 0;
}
